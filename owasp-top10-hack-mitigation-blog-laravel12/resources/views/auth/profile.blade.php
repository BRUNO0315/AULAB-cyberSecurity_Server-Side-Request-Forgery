    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        ...
        <div class="card shadow-sm border-0 p-4 mb-4">
          ...
          <h3 class="fw-semibold mb-3"><i class="bi bi-file-earmark-text me-2"></i>Add Documents</h3>
          <!-- <form method="POST"
          ...
          <h5 class="fw-semibold"><i class="bi bi-folder2-open me-2"></i>My Uploaded Files</h5>
          @if(!empty($files))
          <ul class="list-group mt-3">@foreach($files as $file)
            <li class="list-group-item d-flex justify-content-between align-items-center">
              <span>
                <i class="bi bi-file-earmark me-2"></i>
                {{ basename($file) }}
              </span>
              <a href="{{ Storage::url($file) }}" target="_blank" class="btn btn-sm btn-outline-primary">Open</a>
            </li>
            @endforeach
          </ul>
          @else
